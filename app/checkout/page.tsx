  ...
  return <main className="commerce-page">
    ...
    <div className="checkout-layout">
      ...
      <aside className="order-summary"><span className="eyebrow">Order summary</span>
        ...
        <div className="summary-total"><span>Total</span><strong>{currency} {grandTotal.toFixed(2)}</strong></div><p>Secure checkout · 5–7 working-day preparation · Fly Logistics tracking</p>
      </aside>
    </div>
  </main>;
}
