  ...
  return (
    <main>
      ...
      <section className="bag-summary" id="bag">
        ...
        <div><strong>{symbol}{Math.round(total * rate)}</strong><a className={`button primary ${!bag.length ? "disabled" : ""}`} href={bag.length ? "https://flutterwave.com/pay/" : "#shop"} target={bag.length ? "_blank" : undefined}>Checkout with Flutterwave</a><a className={`button paypal ${!bag.length ? "disabled" : ""}`} href={bag.length ? "https://www.paypal.com/paypalme/" : "#shop"} target={bag.length ? "_blank" : undefined}>PayPal checkout</a></div>
      </section>

      <footer><div className="footer-brand"><img src="/afro-fashionstyle-logo.png" alt="" /><p>Contemporary African fashion,<br/>designed without borders.</p></div><div><b>Shop</b><a href="#shop">New arrivals</a><a href="#shop">Dresses</a><a href="#shop">Occasion wear</a><a href="#shop">Made to order</a></div><div><b>Care</b><a href="#">Size guide</a><a href="#">Delivery &amp; returns</a><a href="#">Contact</a><a href="#">Garment care</a></div><div><b>Follow</b><a href="#">Instagram</a><a href="#">Pinterest</a><a href="#">TikTok</a><Link href="/admin">Admin studio</Link></div><small>© 2026 Afro.Fashionstyle · Privacy · Terms · Accessibility</small></footer>
