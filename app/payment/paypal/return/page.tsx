...
function PayPalReturnContent() {
  ...
  return <main className="status-page"><div className="status-card"><BrandStatusLogo/>
    {error ? <>
      ...
      <h1>We couldn’t confirm the payment.</h1><p>{error} No order will be fulfilled until payment is verified.</p>
      <div className="status-actions"><Link className="button primary" href="/#bag">Return to checkout</Link><Link className="text-link" href="/">Continue shopping →</Link></div>
    </> : <>
      <div className="success-mark loading-mark">↻</div><span className="eyebrow">Secure PayPal confirmation</span>
      <h1>Confirming your payment…</h1><p>Please keep this page open while PayPal completes your order.</p>
    </>}
  </div></main>;
}
