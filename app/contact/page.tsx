...
export default function ContactPage() {
  ...
  return <main><PremiumHeader/><section className="contact-page"><div><span className="eyebrow">Personal styling support</span><h1>Let’s find your<br/>perfect piece.</h1><p>Ask about fit, measurements, styling, delivery or choosing the right look for your occasion. Our support team is available 24/7.</p><a href="https://wa.me/2347049841931" target="_blank" rel="noreferrer">Chat on WhatsApp →</a><a href="mailto:afrofashionclub@gmail.com">Email support →</a></div>
    <form onSubmit={async (event) => {
      ...
      <label>What can we help with?<select name="subject"><option>Sizing and measurements</option><option>Product enquiry</option><option>Styling assistance</option><option>Order and delivery support</option></select></label>
