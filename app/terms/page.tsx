...
export default function TermsPage() {
  return <main><PremiumHeader/><article className="policy-page"><span className="eyebrow">Legal</span><h1>Terms &amp; conditions</h1><p>Last updated July 26, 2026.</p>
    ...
    <h2>Order preparation and final sale</h2><p>Outfit preparation normally requires 5–7 working days. Customers should forward their measurements when unsure of sizing. Orders cannot be returned, exchanged or refunded after preparation begins, except where mandatory consumer law requires a remedy for faulty or incorrectly supplied goods.</p>
