...
export const metadata = {
  ...
  description: "Use the Afro.Fashionstyle women’s size and measurement guide to choose Nigerian dresses and occasion wear confidently in US and UK sizing.",
  alternates: { canonical: "/size-guide" },
};

export default function SizeGuidePage() {
  return <main><PremiumHeader/><article className="policy-page"><span className="eyebrow">Find your best fit</span><h1>Size &amp; measurement guide</h1><p>Choose your size carefully before ordering. Our team can review your measurements and help you select the most suitable fit.</p>
